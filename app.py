...
app.layout = html.Div(children=[
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dcc.RadioItems(["gross income", "Rating"], "gross income", id="main_variable", inputStyle={'margin': '10px', 'padding':'20px'}),
                    ...
                    dbc.Col([
                        ...
                        dbc.Row([dcc.Graph(id="income_fig")]),
...
#callbacks
@app.callback([Output("city_fig", 'figure'),
